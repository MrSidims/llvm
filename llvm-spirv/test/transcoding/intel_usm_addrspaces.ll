...
entry:
; CHECK-LLVM: %DEVICE = alloca i32 addrspace(11)*, align 8
; CHECK-LLVM-NO-USM: %DEVICE = alloca i32 addrspace(1)*, align 8
  %DEVICE = alloca i32 addrspace(11)*, align 8

; CHECK-LLVM: %HOST = alloca i32 addrspace(12)*, align 8
; CHECK-LLVM-NO-USM: %HOST = alloca i32 addrspace(1)*, align 8
  %HOST = alloca i32 addrspace(12)*, align 8

; CHECK-LLVM: bitcast i32 addrspace(11)** %DEVICE to i8*
; CHECK-LLVM-NO-USM: bitcast i32 addrspace(1)** %DEVICE to i8*
  %0 = bitcast i32 addrspace(11)** %DEVICE to i8*
  call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #4

; CHECK-LLVM: bitcast i32 addrspace(12)** %HOST to i8*
; CHECK-LLVM-NO-USM: bitcast i32 addrspace(1)** %HOST to i8*
  %1 = bitcast i32 addrspace(12)** %HOST to i8*
  call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #4

; CHECK-LLVM: %[[DLOAD_E:[0-9]+]] = load i32 addrspace(11)*, i32 addrspace(11)** %DEVICE, align 8
; CHECK-LLVM-NO-USM: %[[DLOAD_NE:[0-9]+]] = load i32 addrspace(1)*, i32 addrspace(1)** %DEVICE, align 8
  %2 = load i32 addrspace(11)*, i32 addrspace(11)** %DEVICE, align 8, !tbaa !5

; CHECK-LLVM: addrspacecast i32 addrspace(11)* %[[DLOAD_E]] to i32 addrspace(4)*
; CHECK-LLVM-NO-USM: addrspacecast i32 addrspace(1)* %[[DLOAD_NE]] to i32 addrspace(4)*
  %3 = addrspacecast i32 addrspace(11)* %2 to i32 addrspace(4)*
  call spir_func void @_Z3fooPi(i32 addrspace(4)* %3)

; CHECK-LLVM: %[[HLOAD_E:[0-9]+]] = load i32 addrspace(12)*, i32 addrspace(12)** %HOST, align 8
; CHECK-LLVM-NO-USM: %[[HLOAD_NE:[0-9]+]] = load i32 addrspace(1)*, i32 addrspace(1)** %HOST, align 8
  %4 = load i32 addrspace(12)*, i32 addrspace(12)** %HOST, align 8, !tbaa !5

; CHECK-LLVM: addrspacecast i32 addrspace(12)* %[[HLOAD_E]] to i32 addrspace(4)*
; CHECK-LLVM-NO-USM: addrspacecast i32 addrspace(1)* %[[HLOAD_NE]] to i32 addrspace(4)*
  %5 = addrspacecast i32 addrspace(12)* %4 to i32 addrspace(4)*
  call spir_func void @_Z3fooPi(i32 addrspace(4)* %5)

; CHECK-LLVM: bitcast i32 addrspace(12)** %HOST to i8*
; CHECK-LLVM-NO-USM: bitcast i32 addrspace(1)** %HOST to i8*
  %6 = bitcast i32 addrspace(12)** %HOST to i8*
  call void @llvm.lifetime.end.p0i8(i64 8, i8* %6) #4

; CHECK-LLVM: bitcast i32 addrspace(11)** %DEVICE to i8*
; CHECK-LLVM-NO-USM: bitcast i32 addrspace(1)** %DEVICE to i8*
  %7 = bitcast i32 addrspace(11)** %DEVICE to i8*
...
; CHECK-SPIRV-EXT: GenericCastToPtrINTEL {{[0-9]+}} [[CAST_TO1:[0-9]+]] [[CAST_FROM1]]
; CHECK-SPIRV-NO-EXT: GenericCastToPtr {{[0-9]+}} [[CAST_TO1:[0-9]+]] [[CAST_FROM1]]
; CHECL-SPIRV: Store [[DEVICE_ARG1]] [[CAST_TO1]] {{[0-9]+}} {{[0-9]+}}
; Function Attrs: norecurse nounwind
define spir_func void @_Z3booPii(i32 addrspace(1)* %arg_glob, i32 addrspace(11)* %arg_dev) #3 !kernel_arg_addr_space !9 {
entry:
  %arg_glob.addr = alloca i32 addrspace(1)*, align 4
  %arg_dev.addr = alloca i32 addrspace(11)*, align 4
  store i32 addrspace(1)* %arg_glob, i32 addrspace(1)** %arg_glob.addr, align 4
  store i32 addrspace(11)* %arg_dev, i32 addrspace(11)** %arg_dev.addr, align 4
  %0 = load i32 addrspace(1)*, i32 addrspace(1)** %arg_glob.addr, align 4
; CHECK-LLVM: addrspacecast i32 addrspace(1)* %{{[0-9]+}} to i32 addrspace(11)*
; CHECK-LLVM-NO-USM-NOT: addrspacecast i32 addrspace(1)* %{{[0-9]+}} to i32 addrspace(11)*
  %1 = addrspacecast i32 addrspace(1)* %0 to i32 addrspace(11)*
  store i32 addrspace(11)* %1, i32 addrspace(11)** %arg_dev.addr, align 4
  ret void
}

; CHECK-SPIRV: Load {{[0-9]+}} [[CAST_FROM2:[0-9]+]] [[GLOB_ARG2]] {{[0-9]+}} {{[0-9]+}}
; CHECK-SPIRV-EXT: GenericCastToPtrINTEL {{[0-9]+}} [[CAST_TO2:[0-9]+]] [[CAST_FROM2]]
; CHECK-SPIRV-NO-EXT: GenericCastToPtr {{[0-9]+}} [[CAST_TO2:[0-9]+]] [[CAST_FROM2]]
; CHECL-SPIRV: Store [[HOST_ARG1]] [[CAST_TO2]] {{[0-9]+}} {{[0-9]+}}
; Function Attrs: norecurse nounwind
define spir_func void @_Z3gooPii(i32 addrspace(1)* %arg_glob, i32 addrspace(12)* %arg_host) #3 !kernel_arg_addr_space !10 {
entry:
  %arg_glob.addr = alloca i32 addrspace(1)*, align 4
  %arg_host.addr = alloca i32 addrspace(12)*, align 4
  store i32 addrspace(1)* %arg_glob, i32 addrspace(1)** %arg_glob.addr, align 4
  store i32 addrspace(12)* %arg_host, i32 addrspace(12)** %arg_host.addr, align 4
  %0 = load i32 addrspace(1)*, i32 addrspace(1)** %arg_glob.addr, align 4
; CHECK-LLVM: addrspacecast i32 addrspace(1)* %{{[0-9]+}} to i32 addrspace(12)*
; CHECK-LLVM-NO-USM-NOT: addrspacecast i32 addrspace(1)* %{{[0-9]+}} to i32 addrspace(12)*
  %1 = addrspacecast i32 addrspace(1)* %0 to i32 addrspace(12)*
  store i32 addrspace(12)* %1, i32 addrspace(12)** %arg_host.addr, align 4
  ret void
}

; CHECK-SPIRV: Load {{[0-9]+}} [[CAST_FROM3:[0-9]+]] [[DEVICE_ARG2]] {{[0-9]+}} {{[0-9]+}}
; CHECK-SPIRV-EXT: PtrCastToGenericINTEL {{[0-9]+}} [[CAST_TO3:[0-9]+]] [[CAST_FROM3]]
; CHECK-SPIRV-NO-EXT: PtrCastToGeneric {{[0-9]+}} [[CAST_TO3:[0-9]+]] [[CAST_FROM3]]
; CHECL-SPIRV: Store [[GLOB_ARG3]] [[CAST_TO3]] {{[0-9]+}} {{[0-9]+}}
; Function Attrs: norecurse nounwind
define spir_func void @_Z3zooPii(i32 addrspace(1)* %arg_glob, i32 addrspace(11)* %arg_dev) #3 !kernel_arg_addr_space !9 {
entry:
  %arg_glob.addr = alloca i32 addrspace(1)*, align 4
  %arg_dev.addr = alloca i32 addrspace(11)*, align 4
  store i32 addrspace(1)* %arg_glob, i32 addrspace(1)** %arg_glob.addr, align 4
  store i32 addrspace(11)* %arg_dev, i32 addrspace(11)** %arg_dev.addr, align 4
  %0 = load i32 addrspace(11)*, i32 addrspace(11)** %arg_dev.addr, align 4
; CHECK-LLVM: addrspacecast i32 addrspace(11)* %{{[0-9]+}} to i32 addrspace(1)*
; CHECK-LLVM-NO-USM-NOT: addrspacecast i32 addrspace(11)* %{{[0-9]+}} to i32 addrspace(1)*
  %1 = addrspacecast i32 addrspace(11)* %0 to i32 addrspace(1)*
  store i32 addrspace(1)* %1, i32 addrspace(1)** %arg_glob.addr, align 4
  ret void
}

; CHECK-SPIRV: Load {{[0-9]+}} [[CAST_FROM4:[0-9]+]] [[HOST_ARG2]] {{[0-9]+}} {{[0-9]+}}
; CHECK-SPIRV-EXT: PtrCastToGenericINTEL {{[0-9]+}} [[CAST_TO4:[0-9]+]] [[CAST_FROM4]]
; CHECK-SPIRV-NO-EXT: PtrCastToGeneric {{[0-9]+}} [[CAST_TO4:[0-9]+]] [[CAST_FROM4]]
; CHECL-SPIRV: Store [[GLOB_ARG4]] [[CAST_TO4]] {{[0-9]+}} {{[0-9]+}}
; Function Attrs: norecurse nounwind
define spir_func void @_Z3mooPii(i32 addrspace(1)* %arg_glob, i32 addrspace(12)* %arg_host) #3 !kernel_arg_addr_space !10 {
entry:
  %arg_glob.addr = alloca i32 addrspace(1)*, align 4
  %arg_host.addr = alloca i32 addrspace(12)*, align 4
  store i32 addrspace(1)* %arg_glob, i32 addrspace(1)** %arg_glob.addr, align 4
  store i32 addrspace(12)* %arg_host, i32 addrspace(12)** %arg_host.addr, align 4
  %0 = load i32 addrspace(12)*, i32 addrspace(12)** %arg_host.addr, align 4
; CHECK-LLVM: addrspacecast i32 addrspace(12)* %{{[0-9]+}} to i32 addrspace(1)*
; CHECK-LLVM-NO-USM-NOT: addrspacecast i32 addrspace(12)* %{{[0-9]+}} to i32 addrspace(1)*
  %1 = addrspacecast i32 addrspace(12)* %0 to i32 addrspace(1)*
  store i32 addrspace(1)* %1, i32 addrspace(1)** %arg_glob.addr, align 4
  ret void
}
