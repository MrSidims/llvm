...
//
//    b) *Post-Dominator-Based Elimination* — Symmetrically, if B post-dominates
//       A and A subsumes B in scope and semantics with no relevant memory
//       accesses on any path, A can be removed.
//
//    c) *Global-to-Local Downgrade* — For barriers that fence global memory
